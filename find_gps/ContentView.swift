...
struct ContentView: View {
    @ObservedObject private var locationManager = ContentViewModel()
    @StateObject  var viewModel = ContentViewModel()
    
    @StateObject var viewModelx:EnvironmentViewModel = EnvironmentViewModel()
   // @State private var cancellable: A
    
    
 //   func setCurrentLocation() {
 //       let  cancellable = locationManager.$location.sink (   viewmodel.location, in
 //                                                           ,region = MKCoordinateRegion(center: location?.coordinate ??
 //                       CllocationCoordinate2d(), latitudeinalMeters: 500, longitudinalMeters: 500))
 //   }
    var body: some View {
        ...
        NavigationView{
            VStack {
               ...
               // Text("Lat: \(resultx)")
                ...
                //    NavigationView{
                NavigationLink("This app will provide numbers to you of people who have volunteered to help if you need assistance (example tow).  You may also add your number to provide assistance to other folks.  Click button below please->",
